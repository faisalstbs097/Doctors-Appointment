...
// very easy part just verify user is logged in and it is a admin
...
export async function getPendingDoctors() {
    // from the up we will get that the admin is verified or not
    // using(verifyAdmin) and then the getPendingDoctors will work
