/*METADATA
    title → Text you see on the browser tab
    description → Short text that Google shows about this page
What happens automatically
    Browser tab name becomes: Admin Settings – MediMeet
    Page gets a description for SEO*/
