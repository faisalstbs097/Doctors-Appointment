...
export default function OnboardingPage() {
  ...
  /*UI mein form fill hota hai → FormData banta hai →
  submitUserRole(formData) call hota hai →
  ye data useFetch ke fn ko milta hai →
  fn callback ke through setUserRole ko bhej deta hai →
  setUserRole database check karta hai (PATIENT / DOCTOR) →
  aur database update karta hai*/
  ...
  const handlePatientSelection = async () => {
    ...
    //Server ko bheja----UI → submitUserRole → setUserRole (server) → DB
